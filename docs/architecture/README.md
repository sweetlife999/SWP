...
- [`dynamic-view/admin-publish-event-sequence.puml`](dynamic-view/admin-publish-event-sequence.puml)
...
![Admin publishes an event — sequence diagram](dynamic-view/admin-publish-event-sequence.puml)
