...
| [QRT-SMOKE](#qrt-smoke) | [QR-FE](quality-requirements.md#qr-fe--core-public-entry-points-stay-reachable) | Frontend smoke / Playwright | `frontend/src/tests/smoke/*.test.ts` | `deploy.yml` |
