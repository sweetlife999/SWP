...
import { api, photoUrl, type Member, type MemberPatch } from '../lib/api'

// Drag-and-drop (or click) image upload to the server; stores the returned path.
function PhotoUpload({ value, onChange, onError }: { value: string; onChange: (v: string) => void; onError: (m: string) => void }) {
